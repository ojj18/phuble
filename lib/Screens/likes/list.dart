...
class LikedList extends StatefulWidget {
  LikedList({Key key, this.liked_data, this.index}) : super(key: key);
  final liked_data;
  int index;
...
class _PostListState extends State<LikedList> {
  bool enable = true;
  bool disable = true;
  @override
              ...
              child: Container(
                child: Column(
                  children: [
                        ...
                        Row(
                          children: [
                            ...
                            Column(
                              ...
                              children: [
                                Text(
                                  "" + widget.liked_data[widget.index]["name"],
                    ...
                    ReadMoreText(
                      "" + widget.liked_data[widget.index]["desc"],
