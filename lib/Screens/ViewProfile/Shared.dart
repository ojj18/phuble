    ...
    return Container(
      ...
      child: FutureBuilder(
          future: DefaultAssetBundle.of(context)
              .loadString('assets/json/share.json'),
          builder: (context, snapshot) {
            var share_data = json.decode(snapshot.data.toString());
            return ListView.builder(
              ...
              itemCount: share_data == null ? 0 : share_data.length,
            );
          }),
    );
  }
...
class ShareList extends StatefulWidget {
  ShareList({Key key, this.share_data, this.index}) : super(key: key);
  final share_data;
  int index;
...
class _PostListState extends State<ShareList> {
  bool enable = true;
  bool disable = true;
  @override
  Widget build(BuildContext context) {
              ...
              child: Container(
                child: Column(
                  children: [
                        ...
                        Row(
                          children: [
                            ...
                            Column(
                              ...
                              children: [
                                Text(
                                  "" + widget.share_data[widget.index]["name"],
                    ...
                    ReadMoreText(
                      "" + widget.share_data[widget.index]["desc"],
